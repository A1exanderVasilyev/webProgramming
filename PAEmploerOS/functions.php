...
function getList() {
    ...
    $result = mysqli_query($connect, "SELECT students.student_id, students.student_name, faculties.facultiy_name, specialties.specialty_name, groups.group_name, ROUND(AVG(student_performance.mark),1) FROM students 
